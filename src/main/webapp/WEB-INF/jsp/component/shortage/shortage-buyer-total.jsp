    ...
    <div class="col-lg-12" style="background-color: #EBEDF9; min-height: calc(100vh - 110px);">
        ...
        <div class="row no-margin pb-5">
            ...
            <div class="col-sm-6 no-padding" style="text-align: right;">
                ...
                <button class="btn btn-primary btn-custom" data-toggle="modal" data-target="#modal-import"><i class="fa fa-upload"></i> Import File</button>
...
<script>
    ...
    function uploadFile() {
        ...
        var edcFile = $('input[name="input-file-1"]').prop('files')[0];
    ...
    function loadData() {
        ...
        var url = dataset.path + "/api/pm/sd/edc/report/view?" + jQuery.param(data);
    ...
    function exportData() {
        ...
        request.open("POST", "/api/pm/sd/edc/report/export?bu=" + dataset.bu + "&factory=" + dataset.factory + "&cft=" + encodeURIComponent(dataset.cft), true);
