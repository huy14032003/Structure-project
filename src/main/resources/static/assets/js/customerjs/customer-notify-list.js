...
function moveToDetailPage(context) {
    window.open("https://10.224.81.70:6443/customer/customer-detail" + "?factory=" + context.dataset.factory + "&modelName=" + context.dataset.modelName + "&groupName=" + context.dataset.groupName + "&stationName=" + context.dataset.stationName + "&timeSpan=" + dataset.timeSpan);
}

function moveToGuidingPage(context) {
    window.open("https://10.224.81.70:6443/troubleshooting-guide" + "?factory=" + context.dataset.factory + "&modelName=" + context.dataset.modelName + "&groupName=" + context.dataset.groupName + "&stationName=" + context.dataset.stationName);
}
