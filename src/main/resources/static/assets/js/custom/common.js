...
function getUrl(type, factory, modelName, groupName, stationName) {
    var url = "https://10.224.81.70:6443";
...
function activeMenu(path, factory, customer) {
    if (factory != '' && factory != undefined) {
        if (customer != '' && customer != undefined) {
            $('.imenu[path="'+factory.toLowerCase()+'-'+customer.toLowerCase()+'-'+ path +'"]').addClass('active');
        } else $('.imenu[path="'+factory.toLowerCase()+'-'+ path +'"]').addClass('active');
    }
