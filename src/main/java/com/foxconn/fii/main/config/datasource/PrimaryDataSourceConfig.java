package com.foxconn.fii.main.config.datasource;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.foxconn.fii.main.data.primary"}
//        excludeFilters = @ComponentScan.Filter(type = FilterType.REGEX, pattern = "com.foxconn.fii.main.data.*")
)
